...
#define CORE_VOLTAGE_CAP        (1700)   /* mV */
...
#define SYSTEM_BALANCE_MODE_FREQUENCY    (1500)    /* MHz */
#define SYSTEM_PWRSAVE_MODE_FREQUENCY    (1300)    /* MHz */
...
#define CORE_DEFAULT_OC_FREQUENCY  (672)    /* MHz */
