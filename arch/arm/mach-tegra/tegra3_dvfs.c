...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp", 1, 1, KHZ,   204000, 294000, 342000, 475000, 555000,  555000,  555000,  555000,  555000),
#endif
	...
	CORE_DVFS("cpu_lp", 1, 1, KHZ,   204000, 342000, 475000, 555000, 666000,  666000,  666000,  666000,  666000),
#endif
#ifdef CONFIG_LP_OC_700
	CORE_DVFS("cpu_lp", 1, 1, KHZ,   204000, 342000, 475000, 620000, 700000,  700000,  700000,  700000,  700000),
#endif
#ifdef CONFIG_LP_OC_740
	CORE_DVFS("cpu_lp", 1, 1, KHZ,   204000, 294000, 342000, 475000, 620000,  620000,  620000,  620000,  740000),
#endif
#else
	...
	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 332000,  332000,  332000,  332000,  332000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 332000, 332000,  332000,  332000,  332000,  332000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 332000, 332000,  332000,  332000,  332000,  332000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 332000, 332000,  332000,  332000,  332000,  332000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 332000, 332000,  332000,  332000,  332000,  332000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 332000, 332000,  332000,  332000,  332000,  332000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  332000,  332000,  332000,  332000),
#endif
...
#ifdef CONFIG_GPU_OVERCLOCK
#ifdef CONFIG_GPU_OC_332
	CORE_DVFS("host1x", 1, 1, KHZ,        1, 167000, 167000, 167000, 167000,  167000,  167000,  167000,  167000),
#endif
#ifdef CONFIG_GPU_OC_446
	CORE_DVFS("host1x", 1, 1, KHZ,        1, 152000, 188000, 223000, 223000,  223000,  223000,  223000,  223000),
#endif
#ifdef CONFIG_GPU_OC_484
	CORE_DVFS("host1x", 1, 1, KHZ,        1, 152000, 188000, 242000, 242000,  242000,  242000,  242000,  242000),
#endif
#ifdef CONFIG_GPU_OC_520
	CORE_DVFS("host1x", 1, 1, KHZ,        1, 152000, 188000, 222000, 260000,  260000,  260000,  260000,  260000),
#endif
#ifdef CONFIG_GPU_OC_600
	CORE_DVFS("host1x", 1, 1, KHZ,        1, 152000, 188000, 222000, 254000,  300000,  300000,  300000,  300000),
#endif
#ifdef CONFIG_GPU_OC_666
	CORE_DVFS("host1x", 1, 1, KHZ,        1, 152000, 188000, 222000, 254000,  333000,  333000,  333000,  333000),
#endif
#ifdef CONFIG_GPU_OC_700
...
#ifdef CONFIG_GPU_OVERCLOCK
#ifdef CONFIG_GPU_OC_332
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 332000,  332000,  332000,  332000,  332000),
#endif
#ifdef CONFIG_GPU_OC_446
...
#endif
#ifdef CONFIG_GPU_OC_666
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  666000,  666000,  666000,  666000),
#endif
#ifdef CONFIG_GPU_OC_700
...
#ifdef CONFIG_GPU_OVERCLOCK
#ifdef CONFIG_GPU_OC_332
	CORE_DVFS("pll_c",  -1, 1, KHZ,  533000, 667000, 667000, 667000, 667000, 667000, 667000, 667000, 667000),
#endif
#ifdef CONFIG_GPU_OC_446
	CORE_DVFS("pll_c",  -1, 1, KHZ,  533000, 667000, 667000, 892000, 892000, 892000, 892000, 892000, 892000),
#endif
#ifdef CONFIG_GPU_OC_484
	CORE_DVFS("pll_c",  -1, 1, KHZ,  533000, 667000, 667000, 968000, 968000, 968000, 968000, 968000, 968000),
#endif
#ifdef CONFIG_GPU_OC_520
	CORE_DVFS("pll_c",  -1, 1, KHZ,  533000, 667000, 667000, 800000, 1040000, 1040000, 1040000, 1040000, 1040000),
#endif
#ifdef CONFIG_GPU_OC_600
